defmodule SongRecommenderWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: SongRecommenderWeb.Gettext
  ...
  def modal(assigns) do
    ...
    >
      <div
        id={"#{@id}-bg"}
        class="bg-[#303030]/40 fixed inset-0 transition-opacity"
        aria-hidden="true"
      />
      <div
      ...
      >
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-[45rem] p-4">
            <.focus_wrap
              id={"#{@id}-container"}
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SongRecommenderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SongRecommenderWeb.Gettext, "errors", msg, opts)
    end
  end
