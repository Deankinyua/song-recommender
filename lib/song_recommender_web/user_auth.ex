defmodule SongRecommenderWeb.UserAuth do
  @moduledoc false

  use SongRecommenderWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_song_recommender_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      SongRecommenderWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule VideoCallWeb.PageLive do
        use VideoCallWeb, :live_view

        on_mount {VideoCallWeb.UserAuth, :assign_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{VideoCallWeb.UserAuth, :ensure_authenticated}] do
  ...
  """
  @spec redirect_if_user_is_authenticated(plug_conn(), map()) :: plug_conn()
